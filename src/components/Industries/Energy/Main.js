                ...
                <div className="container">
                    <div className="row ">
                        <div className="col-lg-8">
                            ...
                            <h3 className="service-details__title">{t("industries.energy.energy_it")}</h3>
                            <div className="service-details__content">
                                <p>
                                    <b>{t("industries.energy.drive")}</b>
                                </p>
                                <h4>{t("industries.energy.oil")}</h4>
                                <p>
                                    {t("industries.energy.our")}
                                </p>
                                <p>
                                    {t("industries.energy.our_tech")}
                                </p>
                                <p>
                                    {t("industries.energy.health")}
                                </p>
                                <h4>{t("industries.energy.solutions")}
                                </h4>
                                <p>
                                    {t("industries.energy.consumption")}
                                </p>
                                <p>
                                    {t("industries.energy.control")}
                                </p>
                                <p>
                                    {t("industries.energy.supply")}
                                </p>
                                <p>
                                    {t("industries.energy.reports")}
                                </p>
                                <p>
                                    {t("industries.energy.utility")}
                                </p>
                                <p>
                                    {("erp")}
                                </p>
                            ...
                            <div className="row gutter-y-30 service-details__box-wrapper">
                                    ...
                                    <div className="service-details__box">
                                        ...
                                        <div className="service-details__box__content">
                                            <h3 className="service-details__box__title">
                                                <Link to="#">{t("industries.energy.it_consultant")}</Link>
                                            </h3>
                                            <p className="service-details__box__text">
                                                {t("industries.energy.questions")}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6 col-sm-12">
                                    <div className="service-details__box">
                                        ...
                                        <div className="service-details__box__content">
                                            <h3 className="service-details__box__title">
                                                <Link to="#">{t("industries.energy.specialist")}</Link>
                                            </h3>
                                            <p className="service-details__box__text">
                                                {t("industries.energy.reach")}
                                            </p>
                                        </div>
                                    </div>
                                </div>
