...
const Manufactur = () => {
  const {t} = useTranslation();
    ...
    return (
        <>
            <Breadcumb Title={t('breadcrumb.entertainment_it')} Breadcumb={t('industries.common.industries')} />
            <section className="section-padding--bottom section-padding--top service-details--page">
                <div className="container">
                    <div className="row ">
                        <div className="col-lg-8">
                            <div className="service-details__image">{t("industries.manufactur.manufacturing_it_services")}
                                <img src={itc} alt="" />
                            </div>
                            <h3 className="service-details__title"> </h3>
                            <div className="service-details__content">
                                <p>
                                    <b>{t("industries.manufactur.manufacturing_industries")}.</b>
                                </p>
                                <p>
                                {t("industries.manufactur.sreeson")}
                                </p>
                                <p>
                                {t("industries.manufactur.innovative_development")}
                                </p>
                                <p>
                                {t("industries.manufactur.effective_service")}                                </p>
                                <h4>
                                {t("industries.manufactur.industry")}
                                </h4>
                                <p>
                                {t("industries.manufactur.expert_guidance")}
                                </p>
                                <h4>
                                {t("industries.manufactur.digital_manufacturing")}
                                </h4>
                                <p>
                                    <b>{t("industries.manufactur.developement")}</b>
                                </p>
                                <p>
                                {t("industries.manufactur.web_app")}
                                </p>
                                <p>
                                    <b>{t("industries.manufactur.manufacturing")}</b>
                                </p>
                                <p>
                                {t("industries.manufactur.operational_cost")}
                                </p>
                                <p>
                                    <b>{t("industries.manufactur.infrastructure")}</b>
                                </p>
                                <p>
                                {t("industries.manufactur.cloud_infrastructure")}
                                </p>
                                <p>
                                    <b>{t("industries.manufactur.field_service")}</b>
                                </p>
                                <p>
                                {t("industries.manufactur.management")}
                                </p>
