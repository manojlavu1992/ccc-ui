                ...
                <div className="container">
                    <div className="row ">
                        <div className="col-lg-8">
                            ...
                            <h3 className="service-details__title">{t('industries.media.entertainment_it_services')}</h3>
                            <div className="service-details__content">
                                <p>
                                    <b>{t('industries.media.platform')}.</b>
                                </p>
                                <h4>
                                {t('industries.media.media')}
                                </h4>
                                <p>
                                {t('industries.media.entertainment')}
                                </p>
                                <p>
                                {t('industries.media.innovative_technology')}
                                </p>
                                <p>
                                {t('industries.media.complex_entertainment')}
                                </p>
                                <h4>
                                {t('industries.media.Our Segments')}
                                </h4>
                                <p>
                                {t('industries.media.applications')}
                                </p>
                                <h4>
                                {t('industries.media.Custom')}
                                </h4>
                                <p>
                                    <b>
                                    {t('industries.media.application_development')}
                                    </b>
                                </p>
                                <p>
                                {t('industries.media.streaming_prjects')}
                                </p>
                                <p>
                                    <b>{t('industries.media.cloud_services')}</b>
                                </p>
                                <p>
                                {t('industries.media.content_providing')}
                                </p>
                                <p>
                                    <b>{t('industries.media.media_streaming')}</b>
                                </p>
                                <p>
                                {t('industries.media.reduction')}
                                </p>
                                <p>
                                    <b>{t('industries.media.ar_vr')}</b>
                                </p>
                                <p>
                                {t('industries.media.solutions')}
                                </p>
                                <p>
                                    <b>{t('industries.media.consumer_analytics')}</b>
                                </p>
                                <p>
                                {t('industries.media.right_analytics')}
                                </p>
