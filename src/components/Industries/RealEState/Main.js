...
const RealEstate = () => {
  const {t} = useTranslation();
    ...
    return (
        <>
            <Breadcumb Title={t('breadcrumb.real_estate')} Breadcumb={t('industries.common.industries')} />
                ...
                <div className="container">
                    <div className="row ">
                        <div className="col-lg-8">
                            ...
                            <h3 className="service-details__title">{t('industries.real-estate.real_estate_it_services')}</h3>
                            <div className="service-details__content">
                                <p>
                                    <b>{t('industries.real-estate.complete')}</b>
                                </p>
                                <h4>
                                {t('industries.real-estate.it_sol')}
                                </h4>
                                <p>
                                {t('industries.real-estate.technology')}
                                </p>
                                <p>
                                {t('industries.real-estate.property')}
                                </p>
                                <p>
                                {t('industries.real-estate.agents')}
                                </p>
                                <h4>
                                {t('industries.real-estate.Software_Sol')}
                                </h4>
                                <p>
                                    <b>{t('industries.real-estate.Recognition')}</b>
                                </p>
                                <p>
                                {t('industries.real-estate.calculators')}
                                </p>
                                <p>
                                    <b>{t('industries.real-estate.Collaboration')}</b>
                                </p>
                                <p>
                                {t('industries.real-estate.domain')}
                                </p>
                                <p>
                                    <b>{t('industries.real-estate.Location')}</b>
                                </p>
                                <p>
                                {t('industries.real-estate.specially')}
                                </p>
                                <p>
                                    <b>{t('industries.real-estate.property_management')}</b>
                                </p>
                                <p>
                                {t('industries.real-estate.management')}
                                </p>
                                <h4>
                                {t('industries.real-estate.solution')}
                                </h4>
                                <p>
                                    <b>{t('industries.real-estate.Cloud')}</b>
                                </p>
                                <p>
                                {t('industries.real-estate.tracking')}
                                </p>
                                <p>
                                    <b>{t('industries.real-estate.analytics')}</b>
                                </p>
                                <p>
                                {t('industries.real-estate.demographic')}
                                </p>
                                <p>
                                    <b>{t('industries.real-estate.ar_vr')}</b>
                                </p>
                                <p>
                                {t('industries.real-estate.immersive')}
                                </p>
