...
import itc from "../../../assets/images/services/business.png";
...
const Business = () => {
	...
	return (
    <>
      <Breadcumb Title="Business / Technology Consulting Services" Breadcumb="SERVICES" />
        ...
        <div className="container">
          <div className="row ">
            <div className="col-lg-8">
              ...
              <h3 className="service-details__title">Business / Technology Consulting Services</h3>
